...
export const meditations: Meditation[] = [
  { 
    ...
    tags: ["stress", "focus"],
    mediaType: "audio",
    mediaUrl: "/audio/calm-relief.mp3",
  ...
  { 
    ...
    tags: ["focus"],
    mediaType: "audio",
    mediaUrl: "/audio/focus-steady.mp3",
  ...
  { 
    ...
    tags: ["sleep"],
    mediaType: "audio",
    mediaUrl: "/audio/sleep-deep-rest.mp3",
  ...
  { 
    ...
    tags: ["sleep"],
    mediaType: "audio",
    mediaUrl: "/audio/rain-ambience.mp3",
  ...
  },
  {
    ...
    tags: ["stress", "calm"],
    mediaType: "audio",
    mediaUrl: "/audio/forest-ambience.mp3",
